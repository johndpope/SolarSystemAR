...
let jupiter = Planet(planetName: "Jupiter", image: UIImage(named: "2k_jupiter.jpg")!, radius: 0.4, distanceFromCamera: 2)
let saturn = Planet(planetName: "Saturn", image: UIImage(named: "2k_saturn.jpg")!, radius: 0.6, distanceFromCamera: 3)
let uranus = Planet(planetName: "Uranus", image: UIImage(named: "2k_uranus.jpg")!, radius: 0.5, distanceFromCamera: 5)
let neptune = Planet(planetName: "Neptune", image: UIImage(named: "2k_neptune.jpg")!, radius: 0.7, distanceFromCamera: 7)
